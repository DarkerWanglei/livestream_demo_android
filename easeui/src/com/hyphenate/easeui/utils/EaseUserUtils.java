...
public class EaseUserUtils {
    ...
    public static void setAppGiftAvatarByPath(Context context, String path, ImageView imageView) {
        if (path != null) {
            try {
                int avatarResId = Integer.parseInt(path);
                Glide.with(context).load(avatarResId).into(imageView);
            ...
            Glide.with(context).load(R.drawable.default_gift_star).into(imageView);
        }
    }
