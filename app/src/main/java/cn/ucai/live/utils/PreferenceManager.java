...
public class PreferenceManager {
    ...
    private static String SHARED_KEY_SHARED_KEY_PAYMENT_TIP = "SHARED_KEY_SHARED_KEY_PAYMENT_TIP";
    private static String SHARED_KEY_SHARED_KEY_CURRENTUSER_CHANGE = "SHARED_KEY_SHARED_KEY_CURRENTUSER_CHANGE";
    ...
    public void setPayMentTip(boolean tip) {
        editor.putBoolean(SHARED_KEY_SHARED_KEY_PAYMENT_TIP, tip);
        editor.apply();
    }

    public boolean getPayMentTip() {
        return mSharedPreferences.getBoolean(SHARED_KEY_SHARED_KEY_PAYMENT_TIP, false);
    }
    ...
    public void removeCurrentUserInfo() {
        ...
        editor.remove(SHARED_KEY_SHARED_KEY_PAYMENT_TIP);
        editor.apply();
    }
