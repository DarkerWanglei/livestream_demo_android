        ...
        register.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (TextUtils.isEmpty(username)) {
                    ...
                    Toast.makeText(RegisterActivity.this, getResources().getString(R.string.Nick_name_cannot_be_empty), Toast.LENGTH_SHORT).show();
...
//                }
    ...
    private void registerAppServer() {
        NetDao.register(this, username, nickname, password, new OnCompleteListener<String>() {
            @Override
